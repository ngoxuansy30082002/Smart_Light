...
{
    esp_err_t ret = timer_pause(group_num, timer_num);
    return ret;
}
...
static IRAM_ATTR void fade_timercb(void *para)
{
    ...
    if (HW_TIMER_GROUP == TIMER_GROUP_0) {
        ...
        // intr_status = timer_group_get_intr_status_in_isr(TIMER_GROUP_0);
        ...
        // timer_set_alarm_value(TIMER_GROUP_0, timer_idx, TIMER_ALARM_EN);
